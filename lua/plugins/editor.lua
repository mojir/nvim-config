return {
  ...
  -- Project-specific file bookmarks
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>h8', function() harpoon:list():select(8) end, { desc = 'Harpoon file 8' })
      vim.keymap.set('n', '<leader>h9', function() harpoon:list():select(9) end, { desc = 'Harpoon file 9' })
